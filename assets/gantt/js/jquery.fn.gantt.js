...
(function ($, undefined) {
    ...
    $.fn.gantt = function (options) {
        ...
        var settings = {
            ...
            maxScale: "months",
            minScale: "hours",
            // callbacks edit: maksalizm
            onItemClick: function (data, dt) { return; },
            onAddClick: function (e, dt, rowId) { return; },
            onRender: $.noop
        };
        ...
        var core = {
            ...
            leftPanel: function (element) {
                ...
                // edit: maksalizm
                entries.push('<div class="row name"><span class="fn-label" id="addProject">add project</span></div><div class="row desc"></div>');
            ...
            createProgressBar: function (label, desc, classNames, dataObj) {
                ...
                bar.click(function (e) {
                    ...
                    settings.onItemClick(dataObj, dt);
                });
                return bar;
            },
